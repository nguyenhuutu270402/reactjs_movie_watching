...
const CustomTooltipChartLline = <TValue extends ValueType, TName extends NameType>({
  active,
  payload
    ...
    return (
      ...
      >
        <div className='flex w-full items-center  font-bold'>
          ...
          <div className='text-[16px] text-[#FFF]'>{payload[0].payload.connections} Active</div>
        </div>
        <div className='flex w-full items-center  font-bold'>
          <div className='mr-[6px]'>
            <svg xmlns='http://www.w3.org/2000/svg' width='8' height='9' viewBox='0 0 8 9' fill='none'>
...
export default CustomTooltipChartLline
